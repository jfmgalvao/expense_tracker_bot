...
async def post_init(application: Application):
    commands = [
        ...
        BotCommand("remover", "Ex: /remover 105"),
        BotCommand("pagar", "Ex: /pagar 105"),
        BotCommand("editar_valor", "Ex: /editar_valor 105 150.50"),
...
def main():
    ...
    application.add_handler(CommandHandler("receitas", telegram_handler.handle_receitas))
    ...
    application.add_handler(CommandHandler("pagar", telegram_handler.handle_pagar))
    ...
    application.add_handler(CommandHandler("rendimento", telegram_handler.handle_rendimento))
    application.add_handler(CommandHandler("patrimonio", telegram_handler.handle_patrimonio))
